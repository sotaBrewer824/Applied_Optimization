...
//== CLASS DEFINITION =========================================================
    ...
    /* Represents a graph consisting of nodes (or "vertices") connected by edges.
     * Each edge represents a spring connecting two vertices and is stored as a
     * pair of the indices of the two nodes it connects.
     * The index corresponds to the location of the nodes in the 'points_' vector.
     * The 'length_' and 'coeffs_' vectors store the length and coefficient of
     * their corresponding spring/edge. e.g. length_[i] will give you the length
     * of the i-th spring/edge, i.e. edges_[i] */
    class SpringGraph {
    public:
        ...
        int add_edge(const int _vt0, const int _vt1, const double _k, const double _l) {
